get_rand_proxy
проста програма, яка дає випадкову адресу проксі з файлу котрий
завантажується з зовнішнього ресурсу (за замовчуванням файл вибирається з conf.h, але його можна вказати в аргументах).
формат даних: X.X.X.X:X
Рандомізація:
     srand(time(NULL)+getpid());
тому сервери, на яких запущена ця програма, навіть якщо запущена
в один і той же час з такими ж налаштуваннями, матиме різні проксі.
